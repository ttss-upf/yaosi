...
# model paramteres
parser.add_argument(
  '--enc_type', default='transformer', type=str,
  help='Type of encoder Transformer | gat | rnn')
parser.add_argument(
  '--dec_type', default='transformer', type=str,
...
parser.add_argument(
  '--vocab_size', type=int, required=True, help='Vocab Size for the lingual model')
parser.add_argument(
...
parser.add_argument(
  '--max_len', type=int, required=True, help='max length of tokens in one sentence', default=128)
parser.add_argument(
  '--lr', type=float, required=True, help='learning rate')
parser.add_argument(
  '--weight_decay', type=float, required=True, help='weight decay')
parser.add_argument(
...
# parser.add_argument(
#   '--model', default='singlelingual', type=str,
